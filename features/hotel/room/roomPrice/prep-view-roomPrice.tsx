...
export const RoomPriceNamefield: FieldConfig<RoomPriceEntity>[] = [
    { name: "hourPrice", libelle: "Prix par (h):", type: "number", normal: true, min: 1 },
    { name: "nightPrice", libelle: "Prix par (nuit):", type: "number", normal: true, min: 1 },
    { name: "accountRate", libelle: "Taux de compte :", type:"number", normal: true , min: 1 },

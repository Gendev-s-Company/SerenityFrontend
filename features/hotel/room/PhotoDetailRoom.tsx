            ...
            <CarouselItem>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 h-auto sm:h-[400px]">
                {displayPhotos.map((photo) => (
                  <Card
                    key={photo.photoID}
                    className="overflow-hidden border-2 hover:border-primary/50 transition-colors relative group/card
                               h-[220px] sm:h-full"
                  >
                    <CardContent className="p-0 h-full relative">
                      ...
                      <img
                        ...
                        className="object-cover w-full h-full transition-transform
                                   group-hover/card:scale-105 cursor-pointer"
                ...
                {displayPhotos.length <= 0 && (
                  <div className="col-span-full flex items-center justify-center
                                  border border-dashed rounded-xl bg-gray-50
                                  min-h-[220px] sm:h-full"
                  >
